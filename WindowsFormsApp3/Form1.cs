...
namespace WindowsFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            str_Key = WindowsFormsApp3.Properties.Settings.Default["KeyValue"].ToString();

            if (!Convert.ToBoolean(WindowsFormsApp3.Properties.Settings.Default["KeyIsHidden"])) textBox1.Text = str_Key;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                WindowsFormsApp3.Properties.Settings.Default["KeyValue"] = str_Key;
                WindowsFormsApp3.Properties.Settings.Default.Save();
            }
            catch (Exception ex)
            {
        ...
        {
            MailMessage mail = new MailMessage(textBox4.Text, textBox7.Text, textBox6.Text, textBox2.Text);
            mail.Attachments.Add(new Attachment(textBox8.Text));
            SmtpClient client = new SmtpClient(textBox5.Text);
            client.Port = 587;
            client.Credentials = new System.Net.NetworkCredential(textBox10.Text, textBox9.Text);
            client.EnableSsl = true;
            client.Send(mail);
            MessageBox.Show("Message send", "Successful!", MessageBoxButtons.OK);
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    WindowsFormsApp3.Properties.Settings.Default["KeyIsHidden"] = true;
                }
                WindowsFormsApp3.Properties.Settings.Default.Save();
